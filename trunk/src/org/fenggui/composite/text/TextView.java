 ...
 * 
 * Created on 2 oct. 06
 * $Id: TextView.java 475 2008-03-12 12:42:56Z marcmenghin $
 */
 ...
 * and word-wrap.
 * 
 * @author Boris Beaulant, last edited by $Author: marcmenghin $, $Date: 2008-03-12 13:42:56 +0100 (Mi, 12 Mrz 2008) $
...
public class TextView extends ObservableWidget implements ITextWidget
{
	...
	private void fireTextChangedEvent(String text)
	{
		...
		if (getDisplay() != null) getDisplay().fireGlobalEventListener(e);
	}

	@Override
	public Dimension getMinContentSize()
	{
		return new Dimension(this.getMinWidth(), this.fullHeight);
	}
	...
	public void paintContent(Graphics g, IOpenGL gl)
	{
		...
		clipRect.setX(0);
		clipRect.setY(clipRect.getY() - this.getDisplayY() - appearance.getContentHeight());
