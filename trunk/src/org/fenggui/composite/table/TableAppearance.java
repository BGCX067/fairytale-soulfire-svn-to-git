 ...
 * $Id: TableAppearance.java 426 2007-12-20 14:47:28Z marcmenghin $
 */
...
import org.fenggui.composite.table.Table.HeaderControl;
...
public class TableAppearance extends DecoratorAppearance
{
	...
	public Dimension getContentMinSizeHinttmp()
	{
	...
	public void paintContenttmp(Graphics g, IOpenGL gl)
	{
		ITableModel model = table.getModel();
...
//			}
		...
		if (tableHeaderVisible)
		{
			...
			for (int columnIndex = 0; columnIndex < model.getColumnCount(); columnIndex++)
			{
				...
				s = TextUtil.confineString(s, columnWidth - OFFSET, null, TextUtil.ENDMARKER0);
