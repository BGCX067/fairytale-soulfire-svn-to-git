 ...
 * $Id: FontFactory.java 426 2007-12-20 14:47:28Z marcmenghin $
 */
 ...
 * @see RenderStage
 * @see AssemblyLine
 * @author Johannes Schaback, last edited by $Author: marcmenghin $, $Date: 2007-12-20 15:47:28 +0100 (Do, 20 Dez 2007) $
...
public class FontFactory {
	...
	private org.fenggui.binding.render.ImageFont buildCharTexture(ArrayList<BufferedImage> charImages) 
	{
		...
		return new org.fenggui.binding.render.ImageFont(bi, hashtable, fontMetrics.getMaxAscent() + fontMetrics.getMaxDescent());
	 ...
	 * @return FengGUI font
	 */
	public static org.fenggui.binding.render.ImageFont renderStandardFont(java.awt.Font awtFont, boolean antiAliasing, Alphabet alphabet)
	{
