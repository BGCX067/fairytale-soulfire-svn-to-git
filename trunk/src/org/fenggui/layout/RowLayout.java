 ...
 * 
 * $Id: RowLayout.java 434 2008-01-10 10:04:46Z marcmenghin $
 */
	...
	public void doLayout(Container container, List<IWidget> content)
	{
		...
		for (int i = 0; i < content.size(); i++)
		{
			...
			if (horizontal)
			{
				...
				setValidSize(w, (int) freeSpacePerComp + getValidMinWidth(w), container.getAppearance()
						.getContentHeight());
			...
			else
			{
				...
				setValidSize(w, container.getAppearance().getContentWidth(), (int) freeSpacePerComp
						+ getValidMinHeight(w));
