 ...
 * 
 * $Id: MultiLineLabel.java 436 2008-01-14 16:32:13Z marcmenghin $
 */
package org.fenggui;

import java.text.BreakIterator;

import org.fenggui.appearance.MultiLineLabelAppearance;
...
public class MultiLineLabel extends Label
{
	...
	{
		setAppearance(new MultiLineLabelAppearance(this));
	}
	...
	public void setText(String text)
	{
		...
		if (text != null && text.length() > 0) {
				line = wrapText(text, maxCharactersPerLine);				
		}
