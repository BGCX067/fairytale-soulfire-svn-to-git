 ...
 * 
 * $Id: EventBinding.java 540 2008-05-20 11:29:32Z marcmenghin $
 */
...
public class EventBinding implements KeyListener, MouseMotionListener, MouseListener, MouseWheelListener {
    ...
    {
        display.fireMouseMovedEvent(e.getX(), display.getHeight()-e.getY(), EventHelper.getMouseButton(e), e.getClickCount());
    }
    ...
    public void mouseClicked(MouseEvent e) 
    {
    	if (e.getClickCount() % 2 == 0)
    		display.fireMouseDoubleClickEvent(e.getX(), display.getHeight()-e.getY(), 
        		EventHelper.getMouseButton(e), e.getClickCount() / 2);
    	else
    	 display.fireMouseClickEvent(e.getX(), display.getHeight()-e.getY(), 
       		EventHelper.getMouseButton(e), e.getClickCount());
	...
	public void mouseWheelMoved(MouseWheelEvent e) {
		display.fireMouseWheel(e.getX(),  display.getHeight()-e.getY(), e.getWheelRotation() < 0, Math.abs(e.getWheelRotation()), e.getScrollAmount());
	}
