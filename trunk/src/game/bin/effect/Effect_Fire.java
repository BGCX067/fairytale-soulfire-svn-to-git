...
public class Effect_Fire{
	...
	public static Node createFire(Node object){
	    ...
	    manager01.setStartColor(new ColorRGBA(1.0f, 0.312f, 0.121f, 1.0f));
	    manager01.setEndColor(new ColorRGBA(1.0f, 0.312f, 0.121f, 0.0f));
	    ...
	    manager02.setEmissionDirection(new Vector3f(0.0f, 1.0f, 0.0f));
	    ...
	    manager02.setStartColor(new ColorRGBA(1.0f, 0.312f, 0.121f, 1.0f));
	    manager02.setEndColor(new ColorRGBA(1.0f, 0.312f, 0.121f, 0.0f));
	    ...
	    manager03.setEmissionDirection(new Vector3f(0.0f, 1.0f, 0.0f));
	    ...
	    manager03.setStartColor(new ColorRGBA(1.0f, 0.312f, 0.121f, 1.0f));
	    manager03.setEndColor(new ColorRGBA(1.0f, 0.312f, 0.121f, 0.0f));
